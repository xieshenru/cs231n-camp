...
### Week 1
1. 计算机视觉综述  
**slides:** [lecture01](https://github.com/xieshenru/cs231n-camp/blob/dev/slides/cs231n_2018_lecture01.pdf)
- 观看视频 p1 和 p2 热身，了解计算机视觉概述以及历史背景
- 观看 p3 了解整门课程的大纲

2. 学习数据驱动的方法和 KNN 算法和线性分类器[上]  
**slides:** [lecture02](https://github.com/xieshenru/cs231n-camp/blob/dev/slides/cs231n_2018_lecture02.pdf) 
- 观看视频 p4 p5 和 p6
...
1. 学习线性分类器[中 下], 损失函数和优化器  
   **slides:** [lecture03](https://github.com/xieshenru/cs231n-camp/blob/dev/slides/cs231n_2018_lecture03.pdf)
...
### Week3
1. 神经网络初步  
**slides:** [lecture04](https://github.com/xieshenru/cs231n-camp/blob/dev/slides/cs231n_2018_lecture04.pdf)
...
### Week5
1. 卷积神经网络初步
**slides:** [lecture05](https://github.com/xieshenru/cs231n-camp/blob/dev/slides/cs231n_2018_lecture05.pdf)
...
### Week6
1. 如何更好的训练网络(上)  
**slides:** [lecture06](https://github.com/xieshenru/cs231n-camp/blob/dev/slides/cs231n_2018_lecture06.pdf)
...
### Week7
1. 如何更好的训练网络(下)  
**slides:** [lecture07](https://github.com/xieshenru/cs231n-camp/blob/dev/slides/cs231n_2018_lecture07.pdf)
...
### Week8
1. 深度学习框架介绍   
**slides:** [lecture08](https://github.com/xieshenru/cs231n-camp/blob/dev/slides/cs231n_2018_lecture08.pdf)

- 观看视频 p19，了解深度学习的主流框架

2. 经典的网络结构结构  
**slides:** [lecture09](https://github.com/xieshenru/cs231n-camp/blob/dev/slides/cs231n_2018_lecture09.pdf)
...
### Week9
1. 循环神经网络与语言模型  
**slides:** [lecture10](https://github.com/xieshenru/cs231n-camp/blob/dev/slides/cs231n_2018_lecture10.pdf)
...
### Week10
1. 检测与分割  
**slides:** [lecture11](https://github.com/xieshenru/cs231n-camp/blob/dev/slides/cs231n_2018_lecture11.pdf)
...
### Week11
1. 生成对抗网络  
**slides:**  [lecture12](https://github.com/xieshenru/cs231n-camp/blob/dev/slides/cs231n_2018_lecture12.pdf)

- 观看视频 p29，p30 和 p31，了解变分自动编码器和生成对抗网络

2. 卷积的可视化理解  
**slides:** [lecture13](https://github.com/xieshenru/cs231n-camp/blob/dev/slides/cs231n_2018_lecture13.pdf)
...
### Week12
1. 深度强化学习
**slides:** [lecture14](https://github.com/xieshenru/cs231n-camp/blob/dev/slides/cs231n_2018_lecture14.pdf)
